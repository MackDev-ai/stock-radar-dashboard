...
assert(dashboardScript.includes("Brak wystarczajacych danych"), "missing-data verdict is absent from dashboard");
...
assert(html.includes("shadowValidationSummary"), "shadow validation summary missing");
assert(html.includes("shadowComparisonWindows"), "shadow comparison windows missing");
assert(html.includes("shadowComparisonThemes"), "shadow comparison themes missing");
assert(html.includes("shadowComparisonDisagreements"), "shadow comparison disagreements missing");
assert(dashboardScript.includes("data.shadowComparison"), "shadow comparison renderer missing");
